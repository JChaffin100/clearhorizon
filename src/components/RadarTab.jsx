...
export default function RadarTab({ coords, savedCities, defaultZoom = 9, isActive, onRefresh, onSettingsClick }) {
    ...
    <div className="radar-tab" aria-label="Animated weather radar map">
      ...
      <div className="radar-controls" aria-label="Radar controls">
        ...
        <div className="radar-controls__locate">
          ...
          {/* Settings */}
          {onSettingsClick && (
            <button className="radar-btn" onClick={onSettingsClick} aria-label="Open Settings" title="Settings" style={{ marginTop: '8px' }}>
